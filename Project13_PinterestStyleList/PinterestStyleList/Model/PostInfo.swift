...
struct PostInfo {
  ...
  init?(dictionary: [String:Any]) {
    guard let userInfo = dictionary[Constants.JSONResponseKeys.UserInfo.User] as? [String:AnyObject],
      let profileImageInfo = userInfo[Constants.JSONResponseKeys.UserInfo.ProfileImage] as? [String:AnyObject],
       let backgroundImageInfo = dictionary[Constants.JSONResponseKeys.UrlInfo.Urls] as? [String:AnyObject] else {
      return nil
    }
