...
class HighScoreTableViewController: UIViewController {
  ...
  func adjustTableViewTopConstraint() {
    ...
    // Move tableview up
    tableviewTopConstraint.constant -= CGFloat(Constants.layoutContraintValue)
  }
...
extension HighScoreTableViewController : UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    guard let cell = tableView.dequeueReusableCell(
      withIdentifier: Constants.CellIdentifier, for: indexPath) as? ScoreCell else {
  ...
  func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
    ...
    guard let header =
      tableView.dequeueReusableHeaderFooterView(
        withIdentifier: Constants.HighScoreTableViewHeaderIdentifier) as? HighScoreTableViewHeader else {
          return UIView()
    }
